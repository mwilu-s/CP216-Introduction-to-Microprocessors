...
//isLetter will fail when run because bl overwrites lr. That means that after calling another 
//subroutine it will lose its own return address. Therefore, saving lr on the stack fixes that.
stmfd   sp!, {r4, lr}
bl      isLowerCase
cmp     r0, #0
bleq    isUpperCase
