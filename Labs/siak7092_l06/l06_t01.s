...
stmfd   sp!, {fp, lr}     //push old fp and return the address
mov     fp, sp            //set the fp
stmfd   sp!, {r1-r5}      //save registers to be used

ldr     r1, [fp, #8]      // load pointer to first string
ldr     r2, [fp, #12]     // load pointer to second string
ldr     r3, [fp, #16]     // max number of chars to compare
...
ldmfd   sp!, {r1-r5}     //restoring the saved registers
ldmfd   sp!, {fp, pc}    //restore fp
