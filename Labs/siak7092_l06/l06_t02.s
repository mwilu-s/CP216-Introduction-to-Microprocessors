...
ldr    r0, =Max        //address to store max val
stmfd  sp!, {r0}       //push max

ldr    r0, =Min        //address to store min val
stmfd  sp!, {r0}       //push min

ldr    r0, =_Data      //end address of list
stmfd  sp!, {r0}       //push end

ldr    r0, =Data       //start address of list
stmfd  sp!, {r0}       //push start

bl     MinMax          //call subroutine
add    sp, sp, #16     //remove the 4 parameters from stack
